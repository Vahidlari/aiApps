...
from ragnarock.utils.email_provider_factory import EmailProviderFactory, ProviderType
from ragnarock.utils.email_utils.base import EmailProvider
from ragnarock.utils.email_utils.graph_provider import (
    AuthenticationError,
    GraphProvider,
)
from ragnarock.utils.email_utils.imap_provider import IMAPProvider
from ragnarock.utils.email_utils.models import (
    EmailAddress,
    EmailAttachment,
    EmailDraft,
    EmailMessage,
...
class TestIMAPProvider:
    ...
    @patch("ragnarock.utils.email_utils.imap_provider.imaplib.IMAP4_SSL")
    @patch("ragnarock.utils.email_utils.imap_provider.smtplib.SMTP")
...
class TestGraphProvider:
    ...
    @patch("ragnarock.utils.email_utils.graph_provider.requests.get")
    ...
    @patch("ragnarock.utils.email_utils.graph_provider.requests.post")
