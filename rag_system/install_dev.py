...
def main():
    ...
    if not os.path.exists("rag_system_package"):
        print("❌ Error: rag_system_package directory not found")
    ...
    print(
        "   2. Test the installation: python -c 'from rag_system_package import RAGSystem; print(\"✅ Package imported successfully\")'"
    )
    print("   3. Run examples: python rag_system_package/examples/basic_usage.py")
